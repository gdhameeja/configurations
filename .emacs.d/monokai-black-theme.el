(deftheme monokai-black
  "Created 2019-07-02.")

(custom-theme-set-faces
 'monokai-black
 '(default ((t (:family "Consolas" :foundry "MS  " :width normal :height 113 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "#F8F8F2" :background "black" :stipple nil :inherit nil))))
 ...
 '(isearch ((t (:foreground "#272822" :background "#E6DB74" :inherit (region)))))
